package com.android.vageta.widget;
...
/**
 * Created by cocoa on 2015/11/10.10:26
...
public class SimpleDialog {
    ...
    private class Builder {
        ...
        private Builder() {
            ...
            TypedArray a = mContext.obtainStyledAttributes(null, R.styleable.simpleDialog, 0, R.style.DefaultSimpleDialog);
            titleSize = a.getDimensionPixelSize(R.styleable.simpleDialog_simepleDialogTitleSize, 15);
            titleColor = a.getColor(R.styleable.simpleDialog_simepleDialogTitleColor, res.getColor(R.color.black));
            msgColor = a.getColor(R.styleable.simpleDialog_simepleDialogMsgColor, res.getColor(R.color.black));
            msgSize = a.getDimensionPixelSize(R.styleable.simpleDialog_simepleDialogMsgSize, 15);
...
//7
            ...
            mMessageView .setTextSize(TypedValue.COMPLEX_UNIT_PX, msgSize);
